    ...
    <header className=' fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16'>
        ...
        <div className="hidden md:flex w-full h-full items-center justify-between">
            <Link to={'/'} className='flex items-center gap-2'>
              ...
              <p className='text-headingColor text-xl font-bold'> Game Day Grillz </p>
            </Link>
          ...
          <div className='flex items-center gap-8'>
            ...
            className='flex items-center gap-8 ' >
              ...
              <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer'> Reservations  </li>
           </motion.ul>
            ...
            <div className='relative'>
...

              {
               ...
               {
                user && user.email === "metoyerjeanpaul@gmail.com" && (
                  <Link to="/createItem">
                  <p 
...

              {
...

               {
                user && user.email === "metoyerjeanpaul@gmail.com" && (
                  <Link to="/createItem">
                  <p 
                  className="px-4 py-2 flex items-center cursor-pointer gap-3 hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base ">
                  New Item 
                  <MdAdd/> 
                  </p>
               ...
               <ul 
                ...
                <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'> Reservations  </li>
              </ul>
